...
@XmlRootElement(name = "tempUsage")
public class DtoTempUsage implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoTempUsage.Store }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoTempUsage.Executor }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoTempUsage.Limiter }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoTempUsage.Parent }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoTempUsage)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoTempUsage that = ((DtoTempUsage) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempUsage.Executor)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempUsage.Executor that = ((DtoTempUsage.Executor) object);
            {
                List<Object> lhsAny;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempUsage.Limiter)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempUsage.Limiter that = ((DtoTempUsage.Limiter) object);
            {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempUsage.Parent)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempUsage.Parent that = ((DtoTempUsage.Parent) object);
            {
                List<Object> lhsAny;
                lhsAny = (((this.any!= null)&&(!this.any.isEmpty()))?this.getAny():null);
                List<Object> rhsAny;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempUsage.Store)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempUsage.Store that = ((DtoTempUsage.Store) object);
            {
