...
@XmlRootElement(name = "streamJDBCAdapter")
public class DtoStreamJDBCAdapter
    implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoStreamJDBCAdapter.Statements }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoStreamJDBCAdapter)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoStreamJDBCAdapter that = ((DtoStreamJDBCAdapter) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoStreamJDBCAdapter.Statements)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoStreamJDBCAdapter.Statements that = ((DtoStreamJDBCAdapter.Statements) object);
            {
