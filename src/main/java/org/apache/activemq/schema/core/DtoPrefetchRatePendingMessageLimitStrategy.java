...
@XmlType(name = "")
@XmlRootElement(name = "prefetchRatePendingMessageLimitStrategy")
public class DtoPrefetchRatePendingMessageLimitStrategy
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoPrefetchRatePendingMessageLimitStrategy)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoPrefetchRatePendingMessageLimitStrategy that = ((DtoPrefetchRatePendingMessageLimitStrategy) object);
        {
