...
@XmlRootElement(name = "queryBasedSubscriptionRecoveryPolicy")
public class DtoQueryBasedSubscriptionRecoveryPolicy
    implements Equals, HashCode, ToString
{

    @XmlElementRefs({
        @XmlElementRef(name = "broker", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "query", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class, required = false)
    })
    @XmlAnyElement(lax = true)
    protected List<Object> brokerOrQueryOrAny;
    ...
    /**
     * Gets the value of the brokerOrQueryOrAny property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the brokerOrQueryOrAny property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBrokerOrQueryOrAny().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JAXBElement }{@code <}{@link DtoQueryBasedSubscriptionRecoveryPolicy.Query }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoQueryBasedSubscriptionRecoveryPolicy.Broker }{@code >}
     * {@link Object }
     * 
     * 
     */
    public List<Object> getBrokerOrQueryOrAny() {
        if (brokerOrQueryOrAny == null) {
            brokerOrQueryOrAny = new ArrayList<Object>();
        }
        return this.brokerOrQueryOrAny;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Object> theBrokerOrQueryOrAny;
            theBrokerOrQueryOrAny = (((this.brokerOrQueryOrAny!= null)&&(!this.brokerOrQueryOrAny.isEmpty()))?this.getBrokerOrQueryOrAny():null);
            strategy.appendField(locator, this, "brokerOrQueryOrAny", buffer, theBrokerOrQueryOrAny);
        }
        {
            String theBroker;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Object> theBrokerOrQueryOrAny;
            theBrokerOrQueryOrAny = (((this.brokerOrQueryOrAny!= null)&&(!this.brokerOrQueryOrAny.isEmpty()))?this.getBrokerOrQueryOrAny():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "brokerOrQueryOrAny", theBrokerOrQueryOrAny), currentHashCode, theBrokerOrQueryOrAny);
        }
        {
            String theBroker;
            theBroker = this.getBroker();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoQueryBasedSubscriptionRecoveryPolicy)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoQueryBasedSubscriptionRecoveryPolicy that = ((DtoQueryBasedSubscriptionRecoveryPolicy) object);
        {
            List<Object> lhsBrokerOrQueryOrAny;
            lhsBrokerOrQueryOrAny = (((this.brokerOrQueryOrAny!= null)&&(!this.brokerOrQueryOrAny.isEmpty()))?this.getBrokerOrQueryOrAny():null);
            List<Object> rhsBrokerOrQueryOrAny;
            rhsBrokerOrQueryOrAny = (((that.brokerOrQueryOrAny!= null)&&(!that.brokerOrQueryOrAny.isEmpty()))?that.getBrokerOrQueryOrAny():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "brokerOrQueryOrAny", lhsBrokerOrQueryOrAny), LocatorUtils.property(thatLocator, "brokerOrQueryOrAny", rhsBrokerOrQueryOrAny), lhsBrokerOrQueryOrAny, rhsBrokerOrQueryOrAny)) {
                return false;
            }
        }
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoQueryBasedSubscriptionRecoveryPolicy.Broker)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoQueryBasedSubscriptionRecoveryPolicy.Broker that = ((DtoQueryBasedSubscriptionRecoveryPolicy.Broker) object);
            {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoQueryBasedSubscriptionRecoveryPolicy.Query)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoQueryBasedSubscriptionRecoveryPolicy.Query that = ((DtoQueryBasedSubscriptionRecoveryPolicy.Query) object);
            {
                List<Object> lhsAny;
