...
@XmlType(name = "")
@XmlRootElement(name = "defaultUsageCapacity")
public class DtoDefaultUsageCapacity
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoDefaultUsageCapacity)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoDefaultUsageCapacity that = ((DtoDefaultUsageCapacity) object);
        {
            Long lhsLimit;
