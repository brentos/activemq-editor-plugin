...
@XmlType(name = "")
@XmlRootElement(name = "jaasAuthenticationPlugin")
public class DtoJaasAuthenticationPlugin implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoJaasAuthenticationPlugin)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoJaasAuthenticationPlugin that = ((DtoJaasAuthenticationPlugin) object);
        {
