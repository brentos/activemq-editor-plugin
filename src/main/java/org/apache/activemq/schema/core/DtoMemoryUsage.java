...
public class DtoMemoryUsage implements Equals, HashCode, ToString
{
    ...
    @XmlAttribute(name = "percentOfJvmHeap")
     ...
     * {@link JAXBElement }{@code <}{@link DtoMemoryUsage.Parent }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoMemoryUsage.Limiter }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoMemoryUsage.Executor }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            BigInteger thePercentOfJvmHeap;
            thePercentOfJvmHeap = this.getPercentOfJvmHeap();
            strategy.appendField(locator, this, "percentOfJvmHeap", buffer, thePercentOfJvmHeap);
        }
        {
        ...
        {
            Float thePortion;
            thePortion = this.getPortion();
            strategy.appendField(locator, this, "portion", buffer, thePortion);
        }
        {
            Long theUsage;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            BigInteger thePercentOfJvmHeap;
            thePercentOfJvmHeap = this.getPercentOfJvmHeap();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "percentOfJvmHeap", thePercentOfJvmHeap), currentHashCode, thePercentOfJvmHeap);
        }
        {
            BigInteger thePercentUsage;
            thePercentUsage = this.getPercentUsage();
        ...
        }
        {
            Float thePortion;
            thePortion = this.getPortion();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "portion", thePortion), currentHashCode, thePortion);
        }
        {
            Long theUsage;
            theUsage = this.getUsage();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoMemoryUsage)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoMemoryUsage that = ((DtoMemoryUsage) object);
        {
        ...
        {
            BigInteger lhsPercentOfJvmHeap;
            lhsPercentOfJvmHeap = this.getPercentOfJvmHeap();
            BigInteger rhsPercentOfJvmHeap;
            rhsPercentOfJvmHeap = that.getPercentOfJvmHeap();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "percentOfJvmHeap", lhsPercentOfJvmHeap), LocatorUtils.property(thatLocator, "percentOfJvmHeap", rhsPercentOfJvmHeap), lhsPercentOfJvmHeap, rhsPercentOfJvmHeap)) {
                return false;
            }
        }
        {
        ...
        {
            Float lhsPortion;
            lhsPortion = this.getPortion();
            Float rhsPortion;
            rhsPortion = that.getPortion();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "portion", lhsPortion), LocatorUtils.property(thatLocator, "portion", rhsPortion), lhsPortion, rhsPortion)) {
                return false;
            }
        }
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoMemoryUsage.Executor)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoMemoryUsage.Executor that = ((DtoMemoryUsage.Executor) object);
            {
                List<Object> lhsAny;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoMemoryUsage.Limiter)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoMemoryUsage.Limiter that = ((DtoMemoryUsage.Limiter) object);
            {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoMemoryUsage.Parent)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoMemoryUsage.Parent that = ((DtoMemoryUsage.Parent) object);
            {
                List<Object> lhsAny;
                lhsAny = (((this.any!= null)&&(!this.any.isEmpty()))?this.getAny():null);
                List<Object> rhsAny;
