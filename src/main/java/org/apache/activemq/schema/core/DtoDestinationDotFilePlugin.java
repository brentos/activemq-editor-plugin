...
@XmlType(name = "")
@XmlRootElement(name = "destinationDotFilePlugin")
public class DtoDestinationDotFilePlugin implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoDestinationDotFilePlugin)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoDestinationDotFilePlugin that = ((DtoDestinationDotFilePlugin) object);
        {
            String lhsFile;
