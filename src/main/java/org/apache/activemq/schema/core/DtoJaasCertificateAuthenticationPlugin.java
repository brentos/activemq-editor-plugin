...
@XmlType(name = "")
@XmlRootElement(name = "jaasCertificateAuthenticationPlugin")
public class DtoJaasCertificateAuthenticationPlugin implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoJaasCertificateAuthenticationPlugin)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoJaasCertificateAuthenticationPlugin that = ((DtoJaasCertificateAuthenticationPlugin) object);
        {
