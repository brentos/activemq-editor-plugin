...
@XmlType(name = "")
@XmlRootElement(name = "cachedMessageGroupMapFactory")
public class DtoCachedMessageGroupMapFactory
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoCachedMessageGroupMapFactory)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoCachedMessageGroupMapFactory that = ((DtoCachedMessageGroupMapFactory) object);
        {
