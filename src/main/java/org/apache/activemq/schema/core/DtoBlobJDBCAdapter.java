...
@XmlRootElement(name = "blobJDBCAdapter")
public class DtoBlobJDBCAdapter
    implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoBlobJDBCAdapter.Statements }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoBlobJDBCAdapter)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoBlobJDBCAdapter that = ((DtoBlobJDBCAdapter) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoBlobJDBCAdapter.Statements)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoBlobJDBCAdapter.Statements that = ((DtoBlobJDBCAdapter.Statements) object);
            {
