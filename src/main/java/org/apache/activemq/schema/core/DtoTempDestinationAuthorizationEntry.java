...
@XmlRootElement(name = "tempDestinationAuthorizationEntry")
public class DtoTempDestinationAuthorizationEntry
    implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoTempDestinationAuthorizationEntry.WriteACLs }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoTempDestinationAuthorizationEntry.AdminACLs }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoTempDestinationAuthorizationEntry.Destination }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoTempDestinationAuthorizationEntry.ReadACLs }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoTempDestinationAuthorizationEntry)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoTempDestinationAuthorizationEntry that = ((DtoTempDestinationAuthorizationEntry) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempDestinationAuthorizationEntry.AdminACLs)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempDestinationAuthorizationEntry.AdminACLs that = ((DtoTempDestinationAuthorizationEntry.AdminACLs) object);
            {
                List<Object> lhsAny;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempDestinationAuthorizationEntry.Destination)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempDestinationAuthorizationEntry.Destination that = ((DtoTempDestinationAuthorizationEntry.Destination) object);
            {
                DtoQueue lhsQueue;
                lhsQueue = this.getQueue();
                DtoQueue rhsQueue;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempDestinationAuthorizationEntry.ReadACLs)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempDestinationAuthorizationEntry.ReadACLs that = ((DtoTempDestinationAuthorizationEntry.ReadACLs) object);
            {
                List<Object> lhsAny;
                lhsAny = (((this.any!= null)&&(!this.any.isEmpty()))?this.getAny():null);
                List<Object> rhsAny;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoTempDestinationAuthorizationEntry.WriteACLs)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoTempDestinationAuthorizationEntry.WriteACLs that = ((DtoTempDestinationAuthorizationEntry.WriteACLs) object);
            {
                List<Object> lhsAny;
                lhsAny = (((this.any!= null)&&(!this.any.isEmpty()))?this.getAny():null);
                List<Object> rhsAny;
