...
@XmlType(name = "")
@XmlRootElement(name = "constantPendingMessageLimitStrategy")
public class DtoConstantPendingMessageLimitStrategy
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoConstantPendingMessageLimitStrategy)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoConstantPendingMessageLimitStrategy that = ((DtoConstantPendingMessageLimitStrategy) object);
        {
            BigInteger lhsLimit;
