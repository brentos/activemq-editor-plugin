...
@XmlRootElement(name = "bytesJDBCAdapter")
public class DtoBytesJDBCAdapter
    implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoBytesJDBCAdapter.Statements }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoBytesJDBCAdapter)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoBytesJDBCAdapter that = ((DtoBytesJDBCAdapter) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoBytesJDBCAdapter.Statements)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoBytesJDBCAdapter.Statements that = ((DtoBytesJDBCAdapter.Statements) object);
            {
