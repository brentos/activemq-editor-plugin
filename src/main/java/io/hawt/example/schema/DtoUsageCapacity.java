...
@XmlType(name = "")
@XmlRootElement(name = "usageCapacity")
public class DtoUsageCapacity
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoUsageCapacity)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoUsageCapacity that = ((DtoUsageCapacity) object);
        {
            Long lhsLimit;
