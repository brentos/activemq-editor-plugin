...
@XmlRootElement(name = "db2JDBCAdapter")
public class DtoDb2JDBCAdapter
    implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoDb2JDBCAdapter.Statements }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoDb2JDBCAdapter)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoDb2JDBCAdapter that = ((DtoDb2JDBCAdapter) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoDb2JDBCAdapter.Statements)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoDb2JDBCAdapter.Statements that = ((DtoDb2JDBCAdapter.Statements) object);
            {
