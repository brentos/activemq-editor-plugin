 ...
 *       &lt;attribute name="fallbackToDeadLetter" type="{http://www.w3.org/2001/XMLSchema}boolean" />
 ...
 *       &lt;attribute name="sendToDlqIfMaxRetriesExceeded" type="{http://www.w3.org/2001/XMLSchema}boolean" />
...
@XmlType(name = "", propOrder = {
    "adminConnectionContextOrNextOrRedeliveryPolicyMap"
})
@XmlRootElement(name = "redeliveryPlugin")
public class DtoRedeliveryPlugin implements Equals, HashCode, ToString
{
    ...
    protected List<Object> adminConnectionContextOrNextOrRedeliveryPolicyMap;
    @XmlAttribute(name = "adminConnectionContext")
    protected String adminConnectionContext;
    @XmlAttribute(name = "fallbackToDeadLetter")
    protected Boolean fallbackToDeadLetter;
    @XmlAttribute(name = "next")
    protected String next;
    @XmlAttribute(name = "redeliveryPolicyMap")
    protected String redeliveryPolicyMap;
    @XmlAttribute(name = "sendToDlqIfMaxRetriesExceeded")
    protected Boolean sendToDlqIfMaxRetriesExceeded;
    ...
    /**
     * Gets the value of the adminConnectionContextOrNextOrRedeliveryPolicyMap property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the adminConnectionContextOrNextOrRedeliveryPolicyMap property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAdminConnectionContextOrNextOrRedeliveryPolicyMap().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JAXBElement }{@code <}{@link DtoRedeliveryPlugin.AdminConnectionContext }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoRedeliveryPlugin.Next }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoRedeliveryPlugin.RedeliveryPolicyMap }{@code >}
     * {@link Object }
     * 
     * 
     */
    public List<Object> getAdminConnectionContextOrNextOrRedeliveryPolicyMap() {
        if (adminConnectionContextOrNextOrRedeliveryPolicyMap == null) {
            adminConnectionContextOrNextOrRedeliveryPolicyMap = new ArrayList<Object>();
        }
        return this.adminConnectionContextOrNextOrRedeliveryPolicyMap;
    }
    ...
    /**
     * Gets the value of the fallbackToDeadLetter property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the fallbackToDeadLetter property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setFallbackToDeadLetter(Boolean value) {
        this.fallbackToDeadLetter = value;
    }
    ...
    /**
     * Gets the value of the sendToDlqIfMaxRetriesExceeded property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the sendToDlqIfMaxRetriesExceeded property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setSendToDlqIfMaxRetriesExceeded(Boolean value) {
        this.sendToDlqIfMaxRetriesExceeded = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Object> theAdminConnectionContextOrNextOrRedeliveryPolicyMap;
            theAdminConnectionContextOrNextOrRedeliveryPolicyMap = (((this.adminConnectionContextOrNextOrRedeliveryPolicyMap!= null)&&(!this.adminConnectionContextOrNextOrRedeliveryPolicyMap.isEmpty()))?this.getAdminConnectionContextOrNextOrRedeliveryPolicyMap():null);
            strategy.appendField(locator, this, "adminConnectionContextOrNextOrRedeliveryPolicyMap", buffer, theAdminConnectionContextOrNextOrRedeliveryPolicyMap);
        }
        {
        ...
        {
            Boolean theFallbackToDeadLetter;
            theFallbackToDeadLetter = this.isFallbackToDeadLetter();
            strategy.appendField(locator, this, "fallbackToDeadLetter", buffer, theFallbackToDeadLetter);
        }
        {
            String theNext;
        ...
        {
            Boolean theSendToDlqIfMaxRetriesExceeded;
            theSendToDlqIfMaxRetriesExceeded = this.isSendToDlqIfMaxRetriesExceeded();
            strategy.appendField(locator, this, "sendToDlqIfMaxRetriesExceeded", buffer, theSendToDlqIfMaxRetriesExceeded);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Object> theAdminConnectionContextOrNextOrRedeliveryPolicyMap;
            theAdminConnectionContextOrNextOrRedeliveryPolicyMap = (((this.adminConnectionContextOrNextOrRedeliveryPolicyMap!= null)&&(!this.adminConnectionContextOrNextOrRedeliveryPolicyMap.isEmpty()))?this.getAdminConnectionContextOrNextOrRedeliveryPolicyMap():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "adminConnectionContextOrNextOrRedeliveryPolicyMap", theAdminConnectionContextOrNextOrRedeliveryPolicyMap), currentHashCode, theAdminConnectionContextOrNextOrRedeliveryPolicyMap);
        }
        {
            String theAdminConnectionContext;
            theAdminConnectionContext = this.getAdminConnectionContext();
        ...
        }
        {
            Boolean theFallbackToDeadLetter;
            theFallbackToDeadLetter = this.isFallbackToDeadLetter();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "fallbackToDeadLetter", theFallbackToDeadLetter), currentHashCode, theFallbackToDeadLetter);
        }
        {
            String theNext;
            theNext = this.getNext();
        ...
        }
        {
            Boolean theSendToDlqIfMaxRetriesExceeded;
            theSendToDlqIfMaxRetriesExceeded = this.isSendToDlqIfMaxRetriesExceeded();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sendToDlqIfMaxRetriesExceeded", theSendToDlqIfMaxRetriesExceeded), currentHashCode, theSendToDlqIfMaxRetriesExceeded);
        }
        {
            String theId;
            theId = this.getId();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoRedeliveryPlugin)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoRedeliveryPlugin that = ((DtoRedeliveryPlugin) object);
        {
            List<Object> lhsAdminConnectionContextOrNextOrRedeliveryPolicyMap;
            lhsAdminConnectionContextOrNextOrRedeliveryPolicyMap = (((this.adminConnectionContextOrNextOrRedeliveryPolicyMap!= null)&&(!this.adminConnectionContextOrNextOrRedeliveryPolicyMap.isEmpty()))?this.getAdminConnectionContextOrNextOrRedeliveryPolicyMap():null);
            List<Object> rhsAdminConnectionContextOrNextOrRedeliveryPolicyMap;
            rhsAdminConnectionContextOrNextOrRedeliveryPolicyMap = (((that.adminConnectionContextOrNextOrRedeliveryPolicyMap!= null)&&(!that.adminConnectionContextOrNextOrRedeliveryPolicyMap.isEmpty()))?that.getAdminConnectionContextOrNextOrRedeliveryPolicyMap():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "adminConnectionContextOrNextOrRedeliveryPolicyMap", lhsAdminConnectionContextOrNextOrRedeliveryPolicyMap), LocatorUtils.property(thatLocator, "adminConnectionContextOrNextOrRedeliveryPolicyMap", rhsAdminConnectionContextOrNextOrRedeliveryPolicyMap), lhsAdminConnectionContextOrNextOrRedeliveryPolicyMap, rhsAdminConnectionContextOrNextOrRedeliveryPolicyMap)) {
                return false;
            }
        }
        {
        ...
        {
            Boolean lhsFallbackToDeadLetter;
            lhsFallbackToDeadLetter = this.isFallbackToDeadLetter();
            Boolean rhsFallbackToDeadLetter;
            rhsFallbackToDeadLetter = that.isFallbackToDeadLetter();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "fallbackToDeadLetter", lhsFallbackToDeadLetter), LocatorUtils.property(thatLocator, "fallbackToDeadLetter", rhsFallbackToDeadLetter), lhsFallbackToDeadLetter, rhsFallbackToDeadLetter)) {
                return false;
            }
        }
        {
        ...
        {
            Boolean lhsSendToDlqIfMaxRetriesExceeded;
            lhsSendToDlqIfMaxRetriesExceeded = this.isSendToDlqIfMaxRetriesExceeded();
            Boolean rhsSendToDlqIfMaxRetriesExceeded;
            rhsSendToDlqIfMaxRetriesExceeded = that.isSendToDlqIfMaxRetriesExceeded();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "sendToDlqIfMaxRetriesExceeded", lhsSendToDlqIfMaxRetriesExceeded), LocatorUtils.property(thatLocator, "sendToDlqIfMaxRetriesExceeded", rhsSendToDlqIfMaxRetriesExceeded), lhsSendToDlqIfMaxRetriesExceeded, rhsSendToDlqIfMaxRetriesExceeded)) {
                return false;
            }
        }
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoRedeliveryPlugin.AdminConnectionContext)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoRedeliveryPlugin.AdminConnectionContext that = ((DtoRedeliveryPlugin.AdminConnectionContext) object);
            {
                List<Object> lhsAny;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoRedeliveryPlugin.Next)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoRedeliveryPlugin.Next that = ((DtoRedeliveryPlugin.Next) object);
            {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoRedeliveryPlugin.RedeliveryPolicyMap)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoRedeliveryPlugin.RedeliveryPolicyMap that = ((DtoRedeliveryPlugin.RedeliveryPolicyMap) object);
            {
