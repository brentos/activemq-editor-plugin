...
@XmlType(name = "")
@XmlRootElement(name = "runtimeConfigurationPlugin")
public class DtoRuntimeConfigurationPlugin implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoRuntimeConfigurationPlugin)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoRuntimeConfigurationPlugin that = ((DtoRuntimeConfigurationPlugin) object);
        {
            Long lhsCheckPeriod;
