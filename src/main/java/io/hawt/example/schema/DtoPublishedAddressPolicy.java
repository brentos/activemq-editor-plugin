 ...
 *         &lt;choice>
 *           &lt;element name="portMapping" minOccurs="0">
 *             &lt;complexType>
 *               &lt;complexContent>
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
    ...
    implements Equals, HashCode, ToString
{
    ...
    /**
     * Gets the value of the portMappingOrAny property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the portMappingOrAny property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPortMappingOrAny().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Object> getPortMappingOrAny() {
        if (portMappingOrAny == null) {
            portMappingOrAny = new ArrayList<Object>();
        }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Object> thePortMappingOrAny;
            thePortMappingOrAny = (((this.portMappingOrAny!= null)&&(!this.portMappingOrAny.isEmpty()))?this.getPortMappingOrAny():null);
            strategy.appendField(locator, this, "portMappingOrAny", buffer, thePortMappingOrAny);
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Object> thePortMappingOrAny;
            thePortMappingOrAny = (((this.portMappingOrAny!= null)&&(!this.portMappingOrAny.isEmpty()))?this.getPortMappingOrAny():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "portMappingOrAny", thePortMappingOrAny), currentHashCode, thePortMappingOrAny);
        }
        {
            String theClusterClientUriQuery;
            theClusterClientUriQuery = this.getClusterClientUriQuery();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<Object> lhsPortMappingOrAny;
            lhsPortMappingOrAny = (((this.portMappingOrAny!= null)&&(!this.portMappingOrAny.isEmpty()))?this.getPortMappingOrAny():null);
            List<Object> rhsPortMappingOrAny;
            rhsPortMappingOrAny = (((that.portMappingOrAny!= null)&&(!that.portMappingOrAny.isEmpty()))?that.getPortMappingOrAny():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "portMappingOrAny", lhsPortMappingOrAny), LocatorUtils.property(thatLocator, "portMappingOrAny", rhsPortMappingOrAny), lhsPortMappingOrAny, rhsPortMappingOrAny)) {
                return false;
            }
        }
        {
