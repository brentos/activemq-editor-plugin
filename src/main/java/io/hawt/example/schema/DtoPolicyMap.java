 ...
 *             &lt;/complexType>
 *           &lt;/element>
 *           &lt;element name="policyEntries" maxOccurs="unbounded" minOccurs="0">
 *             &lt;complexType>
 *               &lt;complexContent>
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                   &lt;sequence maxOccurs="unbounded" minOccurs="0">
...
public class DtoPolicyMap implements Equals, HashCode, ToString
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "policyEntries", namespace = "http://activemq.apache.org/schema/core", type = JAXBElement.class, required = false)
    })
     ...
     * {@link JAXBElement }{@code <}{@link DtoPolicyMap.PolicyEntries }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoPolicyMap.DefaultEntry }{@code >}
     * {@link JAXBElement }{@code <}{@link DtoPolicyMap.Entries }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoPolicyMap)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoPolicyMap that = ((DtoPolicyMap) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        @XmlElementRef(name = "policyEntry", namespace = "http://activemq.apache.org/schema/core", type = DtoPolicyEntry.class, required = false)
        @XmlAnyElement(lax = true)
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoPolicyMap.DefaultEntry)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoPolicyMap.DefaultEntry that = ((DtoPolicyMap.DefaultEntry) object);
            {
                Object lhsContents;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoPolicyMap.Entries)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoPolicyMap.Entries that = ((DtoPolicyMap.Entries) object);
            {
                List<Object> lhsAny;
    ...
    public static class PolicyEntries
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoPolicyMap.PolicyEntries)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoPolicyMap.PolicyEntries that = ((DtoPolicyMap.PolicyEntries) object);
            {
                List<Object> lhsContents;
                lhsContents = (((this.contents!= null)&&(!this.contents.isEmpty()))?this.getContents():null);
                List<Object> rhsContents;
