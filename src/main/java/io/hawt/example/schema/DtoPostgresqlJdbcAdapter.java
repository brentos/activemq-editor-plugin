    ...
    implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoPostgresqlJdbcAdapter.Statements }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theAcksPkName;
            theAcksPkName = this.getAcksPkName();
            strategy.appendField(locator, this, "acksPkName", buffer, theAcksPkName);
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theAcksPkName;
            theAcksPkName = this.getAcksPkName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "acksPkName", theAcksPkName), currentHashCode, theAcksPkName);
        }
        {
            Boolean theBatchStatements;
            theBatchStatements = this.isBatchStatements();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoPostgresqlJdbcAdapter)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoPostgresqlJdbcAdapter that = ((DtoPostgresqlJdbcAdapter) object);
        {
        ...
        {
            String lhsAcksPkName;
            lhsAcksPkName = this.getAcksPkName();
            String rhsAcksPkName;
            rhsAcksPkName = that.getAcksPkName();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "acksPkName", lhsAcksPkName), LocatorUtils.property(thatLocator, "acksPkName", rhsAcksPkName), lhsAcksPkName, rhsAcksPkName)) {
                return false;
            }
        }
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoPostgresqlJdbcAdapter.Statements)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoPostgresqlJdbcAdapter.Statements that = ((DtoPostgresqlJdbcAdapter.Statements) object);
            {
