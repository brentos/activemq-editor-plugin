...
@XmlRootElement(name = "leaseLockerIOExceptionHandler")
public class DtoLeaseLockerIOExceptionHandler
    implements Equals, HashCode, ToString
{
     ...
     * {@link JAXBElement }{@code <}{@link DtoLeaseLockerIOExceptionHandler.BrokerService }{@code >}
     * {@link Object }
     * 
     * 
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoLeaseLockerIOExceptionHandler)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoLeaseLockerIOExceptionHandler that = ((DtoLeaseLockerIOExceptionHandler) object);
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoLeaseLockerIOExceptionHandler.BrokerService)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoLeaseLockerIOExceptionHandler.BrokerService that = ((DtoLeaseLockerIOExceptionHandler.BrokerService) object);
            {
                DtoBroker lhsBroker;
