...
@XmlType(name = "")
@XmlRootElement(name = "connectionDotFilePlugin")
public class DtoConnectionDotFilePlugin implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DtoConnectionDotFilePlugin)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DtoConnectionDotFilePlugin that = ((DtoConnectionDotFilePlugin) object);
        {
            String lhsFile;
